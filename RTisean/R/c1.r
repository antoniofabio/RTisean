c1 <- function(series,d=-1,m=-1,M=-1,t=-1,n=-1,scale=2,K=100,l=-1,x=0,c=1,pretty=FALSE){    #C
...
out=call_TISEANF_extended(series,options,"c1")

out=colnamesout(out,1,c("radius","mass") )       #C  and following lines
