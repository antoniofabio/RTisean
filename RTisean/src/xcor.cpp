...
void ns_xcor::show_options(char *progname) 
{
...
void ns_xcor::scan_options(int argc,char **argv)
{
  char *out;
...
int ns_xcor::main(int argc,char** argv)
{
columns=NULL;outfile=NULL;stout=1;
