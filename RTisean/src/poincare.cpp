...
void ns_poincare::show_options(char *progname)
{
...
void ns_poincare::scan_options(int n,char** in)
{
  char *out;
...
void ns_poincare::poincare(void)
{
  unsigned long i;
  long j,jd;
  double delta,xcut;
...
int ns_poincare::main(int argc,char** argv)
{

outfile=NULL;dimset=0;compset=0;whereset=0;stdo=1;
infile=NULL;
length=ULONG_MAX;exclude=0;
dim=2;comp=2;delay=1;dir=0;
column=1;
verbosity=0xff;
average=0.0;
