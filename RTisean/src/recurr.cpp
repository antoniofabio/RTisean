...
void ns_recurr::show_options(char *progname)
{
...
void ns_recurr::scan_options(int n,char **in)
{
  char *out;
...
void ns_recurr::lfind_neighbors(void)
{
...
int ns_recurr::main(int argc,char **argv)
{

length=ULONG_MAX;exclude=0;
embed=2;dim=1;delay=1;
verbosity=0xff;
eps=1.e-3;fraction=1.0;
dimset=0;
outfile=NULL;stdo=1;
infile=NULL;
epsset=0;
