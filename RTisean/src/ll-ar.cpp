...
void ns_ll_ar::show_options(char *progname)
{
...
void ns_ll_ar::scan_options(int n,char **in)
{
  char *out;
...
double ns_ll_ar::make_fit(long act,unsigned long number)
{
  double hs,casted;
  int i,j,k,which;
...
int ns_ll_ar::main(int argc,char **argv)
{

nmax=(NMAX-1);

eps0set=0;eps1set=0;causalset=0;
outfile=NULL;stdo=1;
COLUMN=1;
DIM=2;DELAY=1;
verbosity=0xff;
STEP=1;
EPS0=1.e-3;EPS1=1.0;EPSF=1.2;
