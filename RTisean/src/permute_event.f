...
c
      subroutine opts_permute_event()
      end

c-------------------------------------------------------------------
c print version information on permutation scheme
c
      subroutine what_permute_event()
...
c
      subroutine usage_permute_event()
      end

c-------------------------------------------------------------------
c initialise all that is needed for permutation scheme 
c
      subroutine permute_init_event()
      parameter(nx=100000) 
      dimension x(nx)
...
c
      subroutine permute_event(n1,n2)
      common nmax
      external rand
