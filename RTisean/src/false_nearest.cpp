...
void ns_false_nearest::show_options(char *progname)
{
...
void ns_false_nearest::scan_options(int n,char **in)
{
  char *out;
...
char ns_false_nearest::find_nearest(long n,unsigned int dim,double eps)
{
...
int ns_false_nearest::main(int argc,char **argv)
{

outfile=NULL;
infile=NULL;
stdo=1;
length=ULONG_MAX;exclude=0;theiler=0;
column=1;delay=1;maxdim=5;mindim=1;
verbosity=0xff;
rt=10.0;
eps0=1.0e-5;
