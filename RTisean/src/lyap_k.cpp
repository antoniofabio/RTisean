...
void ns_lyap_k::show_options(char *progname)
{
...
void ns_lyap_k::scan_options(int n,char **str)
{
  char *out;
...
void ns_lyap_k::put_in_boxes(double eps)
{
  unsigned long i;
  long j,k;
...
void ns_lyap_k::lfind_neighbors(long act,double eps)
{
...
void ns_lyap_k::iterate_points(long act)
{
  double **lfactor;
  double *dx;
...
int ns_lyap_k::main(int argc,char **argv)
{
