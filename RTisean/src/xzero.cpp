...
void ns_xzero::show_options(char *progname)
{
...
void ns_xzero::scan_options(int n,char **in)
{
  char *out;
...
double ns_xzero::make_fit(unsigned long act,unsigned long number,unsigned long istep)
{
  double casted=0.0;
  int i;
...
int ns_xzero::main(int argc,char **argv)
{
nmax=(NMAX-1);
