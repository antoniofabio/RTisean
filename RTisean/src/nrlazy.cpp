...
void ns_nrlazy::show_options(char *progname)
{
...
void ns_nrlazy::scan_options(int n,char **in)
{
  char *out;
...
unsigned int ns_nrlazy::correct(unsigned long n)
{
...
int ns_nrlazy::main(int argc,char **argv)
{

length=ULONG_MAX;exclude=0;
column=1;dim=5;delay=1;iterations=1;
verbosity=0x3;
eps=1.0e-3;

outfile=NULL;epsset=0;stdo=1;epsvarset=0;
infile=NULL;
