...
void ns_svd::show_options(char *progname)
{
...
void ns_svd::scan_options(int n,char **in)
{
  char *out;
...
void ns_svd::ordne(double *lyap,int *ord)
{
  long i,j,maxi;
  double max;
...
int ns_svd::main(int argc,char **argv)
{
LENGTH=ULONG_MAX;exclude=0;
DIM=2;LDIM=2;COLUMN=1;DELAY=1;
verbosity=0xff;
outfile=NULL;stout=1;make_base=0;dim_set=0;
infile=NULL;
av=0.0;
