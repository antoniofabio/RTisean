...
void ns_sav_gol::show_options(char *progname)
{
...
void ns_sav_gol::scan_options(int n,char **argv)
{
  char *out;
...
double** ns_sav_gol::make_coeff(void)
{
  long i,j,k;
...
double ns_sav_gol::make_norm(void)
{
  double ret=1.0;
  long i;
...
int ns_sav_gol::main(int argc,char **argv)
{
length=ULONG_MAX;exclude=0;
dim=1;
dimset=0;
columns=NULL;
nf=2;nb=2;power=2;deriv=0;
infile=NULL;outfile=NULL;stdo=1;
verbosity=(VER_INPUT|VER_FIRST_LINE);
