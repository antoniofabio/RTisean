...
void ns_mutual::show_options(char *progname)
{
...
void ns_mutual::scan_options(int n,char** in)
{
  char *out;
...
double ns_mutual::make_cond_entropy(long t)
{
...
int ns_mutual::main(int argc,char** argv)
{

file_out=NULL;stout=1;
infile=NULL;
length=ULONG_MAX;exclude=0;
column=1;
verbosity=0xff;
partitions=16;corrlength=20;
