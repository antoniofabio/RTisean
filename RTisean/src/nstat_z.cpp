...
void ns_nstat_z::show_options(char *progname)
{
...
void ns_nstat_z::parse_minus(char *str,char *array,char *wopt)
{
...
void ns_nstat_z::parse_comma(char *str,char *array,char *wopt)
{
...
void ns_nstat_z::parse_out(char *str,char *array,char *which)
{
  unsigned int i;
  char test;
...
void ns_nstat_z::parse_offset(char *str,int *iwhich,char *array,char *which) 
{
  int i,strl;
...
void ns_nstat_z::scan_options(int n,char **in)
{
  unsigned int i;
...
double ns_nstat_z::make_fit(long act,unsigned long number)
{
...
int ns_nstat_z::main(int argc,char **argv)
{
...
infile=NULL;
outfile=NULL;stdo=1;centerset=0;
COLUMN=1;
verbosity=0xff;
DIM=3;DELAY=1;MINN=30;STEP=1;
