...
void ns_rescale::show_options(char *progname)
{
  ...
  fprintf(stderr,"\t-z minimum of the ynew series [default: 0.0]\n");
  fprintf(stderr,"\t-Z maximum of the ynew series [default: 1.0]\n");
...
void ns_rescale::scan_options(int n,char **in)
{
  char *out;
...
int ns_rescale::main(int argc,char **argv)
{
length=ULONG_MAX;exclude=0;
dim=1;
verbosity=0xff;
column=NULL;
outfile=NULL;stdo=1;set_av=0;set_var=0;dimset=0;
infile=NULL;
xmin=0.0;xmax=1.0;
