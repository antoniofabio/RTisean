...
void ns_histogram::show_options(char *progname)
{
  ...
  exit(0);                         //   this is apparently what generates the error in R
}

void ns_histogram::scan_options(int n,char **str)
{
  char *out;
...
void ns_histogram::put_in_boxes(void)
{
  unsigned int i,x;
...
unsigned long ns_histogram::neighbors(double x)
{
...
int ns_histogram::main(int argc,char **argv)
{
...
column=1;
verbosity=0xff;
my_stdout=1;gotsize=0;
outfile=NULL;
infile=NULL;
bsize=1024;bsize1=1023;
